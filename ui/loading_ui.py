...
"border-image: url(:/loader/resource/background.jpg);")
    ...
    def retranslateUi(self, LoadingScreen):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("LoadingScreen", u"\u9879\u76ee\u9009\u62e9", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("LoadingScreen", u"\u53cd\u65e0\u4eba\u673a", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("LoadingScreen", u"\u5e76\u8054\u673a\u5668\u4eba", None))
